...
int main() {
	...
	auto f1 = p.add_file("example-input-1");
	auto f2 = p.add_file("example-input-2");
	...
	auto s1 = f1->substr(6, 5);
	auto s2 = f1->substr(23, 4);
	auto s3 = f2->substr(28, 3);
	...
	auto s4 = b.build();
	auto s5 = s4.substr(11,7);
	auto s6 = s4.substr(20);
